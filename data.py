...
output_dir = "/home/dl/Codes/3DSuper/Outputs"
root_dir = os.path.join(output_dir, project_name)
# Check Path exists
path_lists = [root_dir]
...
training_data_file_name = os.path.join(output_dir, project_name, data_set + '.npy')
testing_data_file_name = os.path.join(output_dir, project_name, test_set + '.npy')
print('#'*50)
