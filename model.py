...
def UNet():
    ...
    encoder_block1_1 = Conv2D(filters=filters, kernel_size=(3,3), padding='same', kernel_initializer=kernel_init)
    encoder_block1_2 = BatchNormalization()
    encoder_block1_3 = Conv2D(filters=filters, kernel_size=(3,3), padding='same', kernel_initializer=kernel_init)
    encoder_block1_4 = BatchNormalization()


    
    encoder_block2_1 = Conv2D(filters=filters*2, kernel_size=(3,3), padding='same', kernel_initializer=kernel_init)
    encoder_block2_2 = BatchNormalization()
    encoder_block2_3 = Conv2D(filters=filters*2, kernel_size=(3,3), padding='same', kernel_initializer=kernel_init)
    encoder_block2_4 = BatchNormalization()


    
    
    encoder_block3_1 = Conv2D(filters=filters*4, kernel_size=(3,3), padding='same', kernel_initializer=kernel_init)
    encoder_block3_2 = BatchNormalization()
    encoder_block3_3 = Conv2D(filters=filters*4, kernel_size=(3,3), padding='same', kernel_initializer=kernel_init)
    encoder_block3_4 = BatchNormalization()

    
    
    encoder_block4_1 = Conv2D(filters=filters*8, kernel_size=(3,3), padding='same', kernel_initializer=kernel_init)
    encoder_block4_2 = BatchNormalization()
    encoder_block4_3 = Conv2D(filters=filters*8, kernel_size=(3,3), padding='same', kernel_initializer=kernel_init)
    encoder_block4_4 = BatchNormalization()



    
    encoder_block44_1 = Conv2D(filters=filters*16, kernel_size=(3,3), padding='same', kernel_initializer=kernel_init)
    encoder_block44_2 = BatchNormalization()
    encoder_block44_3 = Conv2D(filters=filters*16, kernel_size=(3,3), padding='same', kernel_initializer=kernel_init)
    encoder_block44_4 = BatchNormalization()


    
    encoder_block33_1 = Conv2D(filters=filters*8, kernel_size=(3,3), padding='same', kernel_initializer=kernel_init)
    encoder_block33_2 = BatchNormalization()
    encoder_block33_3 = Conv2D(filters=filters*8, kernel_size=(3,3), padding='same', kernel_initializer=kernel_init)
    encoder_block33_4 = BatchNormalization()


    
    
    encoder_block22_1 = Conv2D(filters=filters*4, kernel_size=(3,3), padding='same', kernel_initializer=kernel_init)
    encoder_block22_2 = BatchNormalization()
    encoder_block22_3 = Conv2D(filters=filters*4, kernel_size=(3,3), padding='same', kernel_initializer=kernel_init)
    encoder_block22_4 = BatchNormalization()



    
    
    encoder_block11_1 = Conv2D(filters=filters*2, kernel_size=(3,3), padding='same', kernel_initializer=kernel_init)
    encoder_block11_2 = BatchNormalization()
    encoder_block11_3 = Conv2D(filters=filters*2, kernel_size=(3,3), padding='same', kernel_initializer=kernel_init)
    encoder_block11_4 = BatchNormalization()


    
    
    encoder_block0_1 = Conv2D(filters=filters, kernel_size=(3,3), padding='same', kernel_initializer=kernel_init)
    encoder_block0_2 = BatchNormalization()
    encoder_block0_3 = Conv2D(filters=filters, kernel_size=(3,3), padding='same', kernel_initializer=kernel_init)
    encoder_block0_4 = BatchNormalization()




    decoder_block4_1 = Conv2DTranspose(filters=filters * 8, kernel_size=(3,3), padding='same', strides=(2,2), kernel_initializer=kernel_init)
    decoder_block4_2 = BatchNormalization()


    
    decoder_block3_1 = Conv2DTranspose(filters=filters * 4, kernel_size=(3,3), padding='same', strides=(2,2), kernel_initializer=kernel_init)
    decoder_block3_2 = BatchNormalization()


    
    decoder_block2_1 = Conv2DTranspose(filters=filters * 2, kernel_size=(3,3), padding='same', strides=(2,2), kernel_initializer=kernel_init)
    decoder_block2_2 = BatchNormalization()


    
    decoder_block1_1 = Conv2DTranspose(filters=filters, kernel_size=(3,3), padding='same', strides=(2,2), kernel_initializer=kernel_init)
    decoder_block1_2 = BatchNormalization()
    ...
    第一次递归
    '''
    attn = AttnGatingBlock(x3,y3,filters * 4,"attn_1")
    x_4 = AveragePooling2D((2,2))(attn)
    x_4 = Dropout(dropout_rate)(x_4, training=True)
    x_4 = encoder_block4_1(x_4)
    x_4 = encoder_block4_2(x_4)
    x_4 = Activation(act_func)(x_4)
    x_4 = encoder_block4_3(x_4)
    x_4 = encoder_block4_4(x_4)
    x_4 = Activation(act_func)(x_4)

    
    y4 = AveragePooling2D((2,2))(x_4)
    y4 = Dropout(dropout_rate)(y4, training=True)
    y4 = encoder_block44_1(y4)
    y4 = encoder_block44_2(y4)
    y4 = Activation(act_func)(y4)
    ...
    第二次递归
    '''
    attn = AttnGatingBlock(x2,y2,filters * 2,"attn_2")
    ...
    attn = AttnGatingBlock(x3,y3,filters * 4,"attn_2_1")
    x_4 = AveragePooling2D((2,2))(attn)
    x_4 = Dropout(dropout_rate)(x_4, training=True)
    x_4 = encoder_block4_1(x_4)
    x_4 = encoder_block4_2(x_4)
...
#     x_2 = AveragePooling2D((2,2))(y1)
#     x_2 = Dropout(dropout_rate)(x_2, training=True)
#     x_2 = encoder_block2_1(x_2)
#     x_2 = encoder_block2_2(x_2)
#     x_2 = Activation(act_func)(x_2)
#     x_2 = encoder_block2_3(x_2)
#     x_2 = encoder_block2_4(x_2)
#     x_2 = Activation(act_func)(x_2)

#     x_3 = AveragePooling2D((2,2))(x_2)
#     x_3 = Dropout(dropout_rate)(x_3, training=True)
#     x_3 = encoder_block3_1(x_3)
#     x_3 = encoder_block3_2(x_3)
#     x_3 = Activation(act_func)(x_3)
